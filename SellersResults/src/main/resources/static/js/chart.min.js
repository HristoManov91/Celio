...
!function (t, e) {
    ...
    function Ut(t, e, i, s) {
        ...
        const r = i.length;
        let l, h, c, d, u;
        for (l = 0; l < r; l++) if (d = i[l], null != d && !0 !== Y(d)) a = Yt(t, n, o, a, d); else if (Y(d)) for (h = 0, c = d.length; h < c; h++) u = d[h], null == u || Y(u) || (a = Yt(t, n, o, a, u));
        t.restore();
        const f = o.length / 2;
        if (f > i.length) {
    ...
    const oe = (t, e, i) => ne(t, i, (s => t[s][e] < i)), ae = (t, e, i) => ne(t, i, (s => t[s][e] >= i));
    ...
    function ce(t, e) {
        ...
        -1 !== n && s.splice(n, 1), s.length > 0 || (le.forEach((e => {
            delete t[e]
        })), delete t._chartjs)
    }
    ...
    function _e(t, e) {
        const {canvas: i, currentDevicePixelRatio: s} = e, n = pe(i), o = "border-box" === n.boxSizing,
            a = be(n, "padding"), r = be(n, "border", "width"), {x: l, y: h, box: c} = function (t, e) {
    ...
    function ve(t, e, i, s) {
        const n = pe(t), o = be(n, "margin"), a = ge(n.maxWidth, t, "clientWidth") || vt,
            r = ge(n.maxHeight, t, "clientHeight") || vt, l = function (t, e, i) {
                let s, n;
                if (void 0 === e || void 0 === i) {
                    const o = fe(t);
                    if (o) {
                        const t = o.getBoundingClientRect(), a = pe(o), r = be(a, "border", "width"), l = be(a, "padding");
        ...
        if ("content-box" === n.boxSizing) {
            const t = be(n, "border", "width"), e = be(n, "padding");
    ...
    function ke(t, e) {
        const i = me(t, e), s = i && i.match(/^(\d+)(\.\d+)?px$/);
        return s ? +s[1] : void 0
    }
    ...
    function Ae(t, e, i, s) {
        const n = Se(e, t), o = [], a = i.axis, r = "x" === a ? "inXRange" : "inYRange";
        let l = !1;
        return function (t, e) {
    ...
    var Te = {
        modes: {
            index(t, e, i, s) {
                const n = Se(e, t), o = i.axis || "x", a = i.intersect ? Ce(t, n, o, s) : Oe(t, n, o, !1, s), r = [];
    ...
    function Ge(t, e, i, s) {
        ...
        const r = Math.max(0, e.outerWidth - qe(a, t, "left", "right")),
            l = Math.max(0, e.outerHeight - qe(a, t, "top", "bottom")), h = r !== t.w, c = l !== t.h;
    ...
    var ei = {
        addBox(t, e) {
            ...
            if (!t) return;
            const n = Be(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                r = function (t) {
                    const e = function (t) {
                            const e = [];
                            let i, s, n, o, a, r;
                            ...
                            return e
                        }(t), i = Ue(e.filter((t => t.box.fullSize)), !0), s = Ue($e(e, "left"), !0),
                        n = Ue($e(e, "right")), o = Ue($e(e, "top"), !0), a = Ue($e(e, "bottom")), r = Ye(e, "x"),
                        l = Ye(e, "y");
                    return {
                        fullSize: i,
            ...
            Ke(u, Be(s));
            const f = Object.assign({maxPadding: u, w: o, h: a, x: n.left, y: n.top}, n), g = Xe(l.concat(h), d);
            Qe(r.fullSize, f, d, g), Qe(l, f, d, g), Qe(h, f, d, g) && Qe(l, f, d, g), function (t) {
    ...
    const oi = (t, e) => t ? t + ht(e) : e, ai = (t, e) => U(e) && "adapters" !== t;
    ...
    function di(t, e, i, s) {
        const n = e._rootScopes, o = li(e._fallback, i, s), a = [...t, ...n], r = new Set;
        r.add(s);
        let l = ui(r, a, i, o || i);
    ...
    const pi = Number.EPSILON || 1e-14, mi = (t, e) => e < t.length && !t[e].skip && t[e],
        xi = t => "x" === t ? "y" : "x";
    ...
    function _i(t, e = "x") {
        const i = xi(e), s = t.length, n = Array(s).fill(0), o = Array(s);
        let a, r, l, h = mi(t, 0);
        for (a = 0; a < s; ++a) if (r = l, l = h, h = mi(t, a + 1), l) {
            if (h) {
                const t = h[e] - l[e];
                n[a] = 0 !== t ? (h[i] - l[i]) / t : 0
            }
    ...
    function vi(t, e, i, s, n) {
        let o, a, r, l;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) _i(t, n); else {
    ...
    const wi = t => 0 === t || 1 === t, Mi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * _t / i),
        ki = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * _t / i) + 1, Si = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
    ...
    function Ci(t, e, i, s) {
        const n = {x: t.cp2x, y: t.cp2y}, o = {x: e.cp1x, y: e.cp1y}, a = Pi(t, n, i), r = Pi(n, o, i), l = Pi(o, e, i),
            h = Pi(a, r, i), c = Pi(r, l, i);
        return Pi(h, c, i)
    }
    ...
    function zi(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i, a = e.length, {
            ...
            between: l,
            normalize: h
        } = Ei(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
    ...
    function Vi(t, e, i, s) {
        return s && s.setContext && i ? function (t, e, i, s) {
            const n = t._chart.getContext(), o = Wi(t.options), {_datasetIndex: a, options: {spanGaps: r}} = t,
                l = i.length, h = [];
    ...
    function is(t, i, s) {
        const n = t.canvas, o = e((e => {
            null !== t.ctx && s(function (t, e) {
                const i = Yi[t.type] || t.type, {x: s, y: n} = _e(t, e);
    ...
    class ss extends ji {
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (Ui(s)) if ("" === t.style.height) t.height = t.width / (e || 2); else {
                    const e = ke(t, "height");
                    void 0 !== e && (t.height = e)
                }
            }(t, e), i) : null
        ...
        addEventListener(t, e, i) {
            ...
            const s = t.$proxies || (t.$proxies = {}), n = {attach: Ki, detach: Gi, resize: ts}[e] || is;
            s[e] = n(t, e, i)
        }
    ...
    const as = "transparent", rs = {
        boolean: (t, e, i) => i > .5 ? e : t, color(t, e, i) {
            const s = W(t || as), n = s.valid && W(e || as);
    ...
    const ys = t => "reset" === t || "none" === t, vs = (t, e) => e ? t : Object.assign({}, t);
    ...
    class ws {
        ...
        linkScales() {
            const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
                s = (t, e, i, s) => "x" === t ? e : "r" === t ? s : i, n = e.xAxisID = K(i.xAxisID, bs(t, "x")),
                o = e.yAxisID = K(i.yAxisID, bs(t, "y")), a = e.rAxisID = K(i.rAxisID, bs(t, "r")), r = e.indexAxis,
    ...
    function Ls(t, e) {
        ...
        const i = Ve(t.font, e), s = Be(t.padding);
    ...
    class Es extends Ms {
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: o} = s, a = n.offset,
                r = this.isHorizontal(), l = this.ticks.length + (a ? 1 : 0), h = Ts(n), c = [],
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: n} = i, o = this.isHorizontal(),
                a = this.ticks, {align: r, crossAlign: l, padding: h, mirror: c} = n, d = Ts(i.grid), u = d + h,
            ...
            for (m = 0, x = a.length; m < x; ++m) {
                ...
                if (o ? (y = M, D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -O.highest.height / 2 - e * S + S : -O.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? O.highest.height / 2 - e * S : O.highest.height - P * S, c && (D *= -1)) : (v = M, D = (1 - P) * S / 2), t.showLabelBackdrop) {
                    const e = Be(t.backdropPadding), i = O.heights[m], s = O.widths[m];
        ...
        drawTitle() {
            ...
            if (!i.display) return;
            const o = Ve(i.font), a = Be(i.padding), r = i.align;
    ...
    function Hs(t) {
        ...
        e.plugins = K(e.plugins, {}), e.scales = function (t, e) {
            const i = ft[t.type] || {scales: {}}, s = e.scales || {}, n = Ws(t.type, e), o = Object.create(null),
            ...
            return Object.keys(s).forEach((t => {
                ...
                const r = Ns(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                o[r] = o[r] || t, a[t] = ot(Object.create(null), [{axis: r}, e, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, r = i.indexAxis || Ws(n, e), l = (ft[n] || {}).scales || {};
    ...
    class qs {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const n = {$shared: !0}, {resolver: o, subPrefixes: a} = Ks(this._resolverCache, t, s);
            let r = o;
            if (function (t, e) {
    ...
    class an {
        constructor(t, e) {
            const s = this.config = new qs(e), n = sn(t), o = on(n);
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                const i = e[t], s = Ns(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
                ...
                const n = e.options, o = n.id, a = Ns(o, n), r = K(n.type, e.dtype);
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Ws(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales(); else {
                    const e = zs.getController(o), {datasetElementType: s, dataElementType: a} = xt.datasets[o];
        ...
        update(t) {
            ...
            const n = new Set(Object.keys(this._listeners)), o = new Set(i.events);
            ...
            r = this._minPadding = i.layout.autoPadding ? r : 0, this._updateLayout(r), s || J(a, (t => {
                t.reset()
            })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {mode: t}), this._layers.sort(Js("z", "_idx")), this._lastEvent && this._eventHandler(this._lastEvent, !0), this.render()
        }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), tn({chart: this})))
        }
    ...
    const rn = () => J(an.instances, (t => t._plugins.invalidate())), ln = !0;
    ...
    class yn extends ws {
        ...
        _calculateBarValuePixels(t) {
            const {_cachedMeta: {vScale: e, _stacked: i}, options: {base: s, minBarLength: n}} = this, o = s || 0,
                a = this.getParsed(t), r = a._custom, l = pn(r);
    ...
    Dn.id = "scatter", Dn.defaults = {showLine: !1, fill: !1}, Dn.overrides = {
    ...
    function Ln(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / bt) / c) / 2, p = r + g + u, m = n - g - u, {
                outerStart: x,
                outerEnd: b,
                innerStart: _,
                innerEnd: y
            } = An(e, d, c, m - p), v = c - x, w = c - b, M = p + x / v, k = m - b / w, S = d + _, P = d + y, D = p + _ / S,
            C = m - y / P;
    ...
    class En extends Ms {
        ...
        inRange(t, e, i) {
            const s = this.getProps(["x", "y"], i), {angle: n, distance: o} = Ft(s, {x: t, y: e}), {
                    startAngle: a,
                    endAngle: r,
                    innerRadius: l,
                    outerRadius: h,
    ...
    function Bn(t, e, i, s) {
        const {points: n, options: o} = e, {count: a, start: r, loop: l, ilen: h} = Fn(n, i, s), c = function (t) {
    ...
    function Vn(t, e, i, s) {
        const n = e.points, {count: o, start: a, ilen: r} = Fn(n, i, s), {move: l = !0, reverse: h} = s || {};
    ...
    function Hn(t, e, i, s) {
        Nn && !e.options.segment ? function (t, e, i, s) {
            ...
            const {segments: n, options: o} = e, a = Wn(e);
    ...
    class jn extends Ms {
        ...
        interpolate(t, e) {
            const i = this.options, s = t[e], n = this.points, o = Fi(this, {property: e, start: s, end: s});
            if (!o.length) return;
        ...
        path(t, e, i) {
            const s = this.segments, n = Wn(this);
            let o = this._loop;
    ...
    function qn(t) {
        const e = Un(t), i = e.right - e.left, s = e.bottom - e.top, n = function (t, e, i) {
            const s = t.options.borderWidth, n = t.borderSkipped, o = ze(s);
            return {
            ...
            const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Fe(n),
    ...
    function Kn(t, e, i, s) {
        const n = null === e, o = null === i, a = t && !(n && o) && Un(t, s);
    ...
    function ro(t, e, i) {
        ...
        for (let n = 0; n < i.length; n++) {
            const o = i[n], {first: a, last: r, point: l} = lo(o, e, "x");
    ...
    function bo(t, e) {
        const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of s) {
                ...
                const h = Fi(e, l);
                for (const e of h) {
                    const s = go(i, o[e.start], o[e.end], e.loop), r = zi(t, n, s);
    ...
    function _o(t, e, i) {
        const s = ho(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
    ...
    class wo extends Ms {
        ...
        fit() {
            ...
            const i = t.labels, s = Ve(i.font), n = s.size, o = this._computeTitleHeight(), {
                boxWidth: a,
                itemHeight: r
            } = vo(i, n);
            let l, h;
        ...
        adjustHitBoxes() {
            ...
            } = this, a = Ti(o, this.left, this.width);
            if (this.isHorizontal()) {
        ...
        _draw() {
            const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this, {align: a, labels: r} = t, l = xt.color,
                h = Ti(t.rtl, this.left, this.width), c = Ve(r.font), {color: d, padding: u} = r, f = c.size, g = f / 2;
            let p;
            this.drawTitle(), s.textAlign = h.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = c.string;
            const {boxWidth: m, boxHeight: x, itemHeight: b} = vo(r, f), _ = this.isHorizontal(),
            ...
            this.legendItems.forEach(((w, M) => {
                ...
                !function (t, e, i) {
                    ...
                    if (s.fillStyle = K(i.fillStyle, l), s.lineCap = K(i.lineCap, "butt"), s.lineDashOffset = K(i.lineDashOffset, 0), s.lineJoin = K(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = K(i.strokeStyle, l), s.setLineDash(K(i.lineDash, [])), r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - x) / 2, 0), a = h.leftForLtr(t, m), r = Fe(i.borderRadius);
        ...
        drawTitle() {
            const t = this.options, e = t.title, i = Ve(e.font), o = Be(e.padding);
            if (!e.display) return;
            const a = Ti(t.rtl, this.left, this.width), r = this.ctx, l = e.position, h = i.size / 2, c = o.top + h;
        ...
        _getLegendItemAt(t, e) {
            let i, s, n;
            if (t >= this.left && t <= this.right && e >= this.top && e <= this.bottom) for (n = this.legendHitBoxes, i = 0; i < n.length; ++i) if (s = n[i], t >= s.left && t <= s.left + s.width && e >= s.top && e <= s.top + s.height) return this.legendItems[i];
            return null
        }
    ...
    class ko extends Ms {
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = Ve(e.font), n = i.lineHeight / 2 + this._padding.top, {
                titleX: o,
                titleY: a,
                maxWidth: r,
                rotation: l
    ...
    function Lo(t, e) {
        const i = t._chart.ctx, {body: s, footer: n, title: o} = t, {boxWidth: a, boxHeight: r} = e, l = Ve(e.bodyFont),
            h = Ve(e.titleFont), c = Ve(e.footerFont), d = o.length, u = n.length, f = s.length, g = Be(e.padding);
    ...
    class Vo extends Ms {
        ...
        _resolveAnimations() {
            ...
            const e = this._chart, i = this.options.setContext(this.getContext()),
                s = i.enabled && e.options.animation && i.animations, n = new cs(this._chart, s);
        ...
        getBody(t, e) {
            ...
            return J(t, (t => {
                const e = {before: [], lines: [], after: []}, n = Bo(i, t);
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Lo(this, i), a = Object.assign({}, t, e), r = Eo(this._chart, i, a),
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {
                ...
                bottomLeft: h,
                bottomRight: c
            } = Fe(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, x, b, _, y;
        ...
        _drawColorBox(t, e, i, s, n) {
            const o = this.labelColors[i], a = this.labelPointStyles[i], {boxHeight: r, boxWidth: l, boxPadding: h} = n,
                c = Ve(n.bodyFont), d = zo(this, "left", n), u = s.x(d),
            ...
            if (n.usePointStyle) {
                ...
                const e = s.leftForLtr(u, l - h), i = s.leftForLtr(s.xPlus(u, 1), l - h - 2), a = Fe(o.borderRadius);
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = Lo(this, t), a = Object.assign({}, i, this._size), r = Eo(e, t, a),
                    l = Io(t, a, r, e);
    ...
    function Zo(t) {
        ...
        for (let h = 0; h < o; h++) {
            ...
            n[h] = o.padding;
            const c = t.getPointPosition(h, t.drawingArea + n[h]), d = Ve(o.font),
                u = (a = t.ctx, r = d, l = Y(l = t._pointLabels[h]) ? l : [l], {
                    w: Ut(a, r.string, l),
                    h: l.length * r.lineHeight
                });
            s[h] = u;
            const f = t.getIndexAngle(h), g = It(f), p = Go(g, c.x, u.w, 0, 180), m = Go(g, c.y, u.h, 90, 270);
        ...
        t._setReductions(t.drawingArea, e, i), t._pointLabelItems = function (t, e, i) {
            const s = [], n = t.getLabels().length, o = t.options, a = Ko(o),
            ...
            for (let o = 0; o < n; o++) {
                const n = 0 === o ? a / 2 : 0, l = t.getPointPosition(o, r + n + i[o]), h = It(t.getIndexAngle(o)),
                    c = e[o], d = ta(l.y, c.h, h), u = Qo(h), f = Jo(l.x, c.w, u);
    ...
    class sa extends Yo {
        ...
        drawGrid() {
            ...
            if (e.pointLabels.display && function (t, e) {
                ...
                for (let n = e - 1; n >= 0; n--) {
                    const e = s.setContext(t.getPointLabelContext(n)), o = Ve(e.font), {
                        x: a,
                        y: r,
                        textAlign: l,
                        left: h,
        ...
        drawLabels() {
            ...
            t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach(((s, a) => {
                ...
                const r = i.setContext(this.getContext(a)), l = Ve(r.font);
    ...
    function la(t, e, i, s) {
        ...
        for (let o = oa.indexOf(t); o < n - 1; ++o) {
            const t = na[oa[o]], n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    class da extends Es {
        ...
        init(t, e) {
            const i = t.time || (t.time = {}), s = this._adapter = new dn._date(t.adapters.date);
        ...
        buildTicks() {
            ...
            const n = this.min, o = re(s, n, this.max);
        ...
        _generate() {
            const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                o = n.unit || la(n.minUnit, e, i, this._getLabelCapacity(e)), a = K(n.stepSize, 1),
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond,
                n = this._tickFormatFunction(t, 0, ca(this, [t], this._majorUnit), s), o = this._getLabelSize(n),
    ...
    function ua(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = oe(t, "pos", e)), ({pos: s, time: o} = t[r]), ({
            pos: n,
            time: a
        } = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = oe(t, "time", e)), ({
            time: s,
            pos: o
